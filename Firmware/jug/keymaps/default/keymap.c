...
const uint16_t PROGMEM qwerty_on_off[] = {LOWER, RAISE, COMBO_END};
const uint16_t PROGMEM caps_lock[] = {KC_LSFT, KC_RSFT, COMBO_END};
const uint16_t PROGMEM delete_l_sft[] = {KC_LSFT, KC_BSPC, COMBO_END};
const uint16_t PROGMEM delete_r_sft[] = {KC_RSFT, KC_DEL, COMBO_END};



combo_t key_combos[] = {
    COMBO(qwerty_on_off, TG(_QWERTY)),
    COMBO(caps_lock, KC_CAPS),
    COMBO(delete_l_sft, KC_DEL),
    COMBO(delete_r_sft, KC_DEL)
};
